...
const AboutPage: React.FC = () => {
  return (
    <div className="flex flex-col gap-8 w-full">
      {/* Hero */}
      <div className="panel-web3 p-6 md:p-12 bg-white relative overflow-hidden group pt-12 md:pt-12">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold uppercase mb-4 drop-shadow-[2px_2px_0px_rgba(0,0,0,1)] pt-2 leading-tight">About</h2>
