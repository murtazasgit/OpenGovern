...
- **Install Project Dependencies**: With `Algorand project bootstrap all`, ensure all dependencies are ready.
...
1. **Build Contracts**: `Algorand project run build` builds react web app and links with smart contracts in workspace, if any.
